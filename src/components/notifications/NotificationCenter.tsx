            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute right-0 mt-2 w-80 sm:w-96 bg-white dark:bg-card shadow-xl rounded-xl border border-border z-50 overflow-hidden"
                    >
                        <div className="p-4 border-b border-border flex justify-between items-center bg-slate-50/50 dark:bg-card/50 backdrop-blur-sm">
                            ...
                            {notifications.length === 0 ? (
                                ...
                                <div className="divide-y divide-border">
                                    {notifications.map((notification) => (
                                        <div
                                            key={notification.id}
                                            className={`p-4 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors relative group ${!notification.read ? 'bg-primary/5 dark:bg-primary/10' : ''}`}
                        ...
                        {notifications.length > 0 && (
                            <div className="p-2 border-t border-border bg-slate-50 dark:bg-card">
                                <button
                                    onClick={() => clearAll()}
